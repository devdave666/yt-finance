...
CHAR_FLOOR = (
    ...
    "flat circle: hair styled exactly as this character's description says "
    "(short and spiky, or long and flowing -- match the reference sheet, "
    "don't default to one style for every character), two small solid-black "
    "dot eyes, two short sharp angled eyebrows, and a clearly drawn mouth that "
